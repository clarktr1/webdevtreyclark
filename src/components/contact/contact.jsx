...
function Contact(){
    ...
    return (
        <Container sx={{backgroundColor: '#1e1e1e', borderRadius: '8px', width:'80vw'}} id="contact">
            ...
            <Grid2 container xs={12} maxWidth='70vw' sx={{backgroundColor: '#ffffff', margin:'4rem auto', borderRadius: '8px'}}>
                <Grid2 item xs={12} md={5} style={{display:'flex', flexDirection:'column', justifyContent: 'center', padding:"8%"}}>
